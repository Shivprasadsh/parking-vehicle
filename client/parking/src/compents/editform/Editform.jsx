...
function EditForm() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const url = `https://parking-vehicle-zbdl.vercel.app/?vercelToolbarCode=daRpxUF3FYwdH-y/api/details/${id}`;
    ...
    const submitHandler = async (e) => {
        ...
        const url = `https://parking-vehicle-zbdl.vercel.app/?vercelToolbarCode=daRpxUF3FYwdH-y/api/update/${id}`;
